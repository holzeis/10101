...
pub fn collect(node: Arc<Node<TenTenOneNodeStorage, InMemoryStore>>, health: Health) {
...
fn node_metrics(cx: &Context, node: Arc<Node<TenTenOneNodeStorage, InMemoryStore>>) {
